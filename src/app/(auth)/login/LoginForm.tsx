      ...
      <div className="z-20 flex flex-col w-full gap-8">
        ...
        >
          <div className="flex flex-col w-full">
            ...
            <input
              type="text"
              className="text-secondary-gray focus:border-b-2 ring-0 border-b-secondary-gray w-full px-2 py-1 border-b outline-none"
              {...register("username")}
            />
  ...
  return (
    <div className="flex flex-col items-center w-full gap-5">
      ...
      <Button
        ...
        type="reset"
        variant={"secondary"}
        className="hidden px-6 py-3 text-center"
      >
        Go Back
      </Button>
    </div>

...
type EditPatientGeneralInfoProps = {
  open: boolean;
  setOpen: React.Dispatch<React.SetStateAction<boolean>>;
  patient: PatientsDataType;
};

const EditPatientGeneralInfo = ({
  open,
  setOpen,
  patient,
}: EditPatientGeneralInfoProps) => {
  ...
  > = async (data) => {
    console.log({ data });
    setOpen(false);
    setOpenEditPatientAdditionalInfo(true);
    toast.success("Patient General Information updated successfully");
    reset();
  };
                    ...
                    <div className="flex flex-col gap-5 px-2 md:px-5">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full">
                        <CustomInputForm
                          ...
                          value={patient.patientName.split(" ")[0]}
                        />
                        ...
                        <CustomInputForm
                          ...
                          value={patient.patientName.split(" ")[1]}
                        />
                      </div>
...
export default EditPatientGeneralInfo;

// Submit form button
const EditPatientGeneralInfoButton = ({
  pending,
  reset,
}: {
  pending: boolean;
